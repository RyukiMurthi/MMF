...
def get_snack ():
    ...
    while desired_snack != "xxx" or desired_snack != "n":
        ...
        snack_choice = string_check(desired_snack, valid_snacks, "Sorry that is not a valid snack")
...
# function to show instruction if necessary
def instructions (options):
    show_help = "invalid choice"
    show_error = "Please answer yes / no"
...
while name != "xxx" and ticket_count < MAX_TICKETS:
    ...
    while how_pay == "invalid choice":
        ...
        how_pay = string_check (how_pay, pay_method, "Please choose cash or credit (ca / cr)")
...
movie_frame.to_csv ("ticket_deatils.csv")
